...
export default function AssistantComposer({
  ...
  return (
    ...
    >
      ...
      <div className="rounded-[22px] border border-slate-200/70 bg-white p-1.5 shadow-[0_2px_14px_rgba(15,23,42,0.07)] dark:border-slate-700/80 dark:bg-slate-900 dark:shadow-[0_2px_18px_rgba(0,0,0,0.35)]">
        <div
            ...
            {loading ? (
              ...
              <Button
                ...
                className={`absolute right-1.5 top-1/2 h-8 min-w-8 w-8 -translate-y-1/2 px-0 text-sm font-semibold rounded-full shadow-sm ${
                  uiColor === "danger" ? "bg-rose-600 text-white" : "bg-teal-600 text-white"
                }`}
              >
                ↑
              </Button>
